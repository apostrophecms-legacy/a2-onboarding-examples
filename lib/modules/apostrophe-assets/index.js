...
module.exports = {
  ...
  construct(self, options) {
    ...
    self.apos.app.get('/assets/js', function (req, res, next) {
      return options.minify
        ? res.rawRedirect(self.assetUrl(`/apos-minified/anon-${self.getThemedGeneration()}.js`))
        : res.status(400).send('This API is only available when assets are properly minified.')
    });
  }
};
